...
def _rebuild_code(
    ...
    *,
    ...
    try:
        from enterpriphy.extract import extract, _get_extractor
        from enterpriphy.detect import detect
        from enterpriphy.build import build_from_json
        from enterpriphy.cluster import cluster, remap_communities_to_previous, score_all
        ...
        if no_cluster:
            ...
            try:
                from enterpriphy.detect import save_manifest
        ...
        if callflow_files and not no_change:
            try:
                from enterpriphy.callflow_html import write_callflow_html
